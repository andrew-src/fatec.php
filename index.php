   ...
   <form method="post" action="crud.php?acao=inserir" name="dados" onSubmit="return enviardados();">
      ...
      <table width="588" border="0" align="center">
         ...
         <tr>
            ...
            <td>
               <font size="2">
                  <input name="email" type="email" id="email" size="52" maxlength="150" class="formbutton">
               </font>
            </td>
         </tr>
         ...
         <tr>
            ...
            <td>
               ...
               <button class="waves-effect waves-light btn" type="submit" name="action" formaction="crud.php?acao=selecionar">Ler</button>               
               <!--               
